import { Accordion, Button, Code, Container, List, Text } from "@mantine/core";
      ...
      <Accordion.Item value="instructions">
        ...
        <Accordion.Panel>
          <List type="ordered">
            ...
            <List.Item>
              You're done! No need to add preconnect/link tags into <Code>&lt;head&gt;</Code> or anything. Remember to set
              appropriate <Code>Cache-Control</Code> headers for the font files!
            </List.Item>
          </List>
        </Accordion.Panel>
      </Accordion.Item>
